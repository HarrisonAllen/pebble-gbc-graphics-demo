...
const int16_t FO_SIGN_1[] = {1, 7, 21, PO_TEXT, 0};
const int16_t FO_SHRINE_1[] = {1, 12, 26, PO_TEXT, 1};
const int16_t FO_SHRINE_2[] = {1, 12, 27, PO_TEXT, 1};
...
const int16_t NP_TRASH_1[] = {2, 10, 49, PO_TEXT, 2};
const int16_t NP_TRASH_2[] = {2, 13, 49, PO_TEXT, 2};
const int16_t NP_TRASH_3[] = {2, 14, 42, PO_TEXT, 2};
const int16_t NP_TRASH_4[] = {2, 32, 42, PO_TEXT, 2};
const int16_t NP_SIGN_1[] = {2, 16, 46, PO_TEXT, 3};
const int16_t NP_SIGN_2[] = {2, 29, 33, PO_TEXT, 4};
const int16_t NP_SIGN_3[] = {2, 14, 6, PO_TEXT, 5};
...
const int16_t R1_SIGN_1[] = {3, 51, 11, PO_TEXT, 6};
const int16_t R1_SIGN_2[] = {3, 5, 9, PO_TEXT, 7};
...
const int16_t R2_SIGN_1[] = {4, 9, 59, PO_TEXT, 8};
const int16_t R2_SIGN_2[] = {4, 7, 6, PO_TEXT, 9};
